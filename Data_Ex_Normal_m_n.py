...
Exponential Distribution noise was added to magnitudes and phases using [2]
Modal Numbers are generated using normal distribution
Date: April 25 2022
Author: Kate Antonov
...
[3] NumPy, "numpy.random.exponential",
https://numpy.org/doc/stable/reference/random/generated/numpy.random.exponential.html
[4] NumPy, "numpy.random.normal",
...
seed(42)
m_1 = np.random.normal(2,0.3,9000)
m = np.zeros(9000)
...
print(m.min())
seed(42)
n_1 = np.random.normal(2,0.3,9000)
n = np.zeros(9000)
...
x_1 = np.random.normal(5,1.117,9000)
pre_x = np.zeros(9000)
for i in range(len(x_1)):
    pre_x[i] = round(x_1[i],4)
#m = round(m_1,0)
#print(x)
print(pre_x.max())
print(pre_x.min())
...
def generate_dataset_abs_with_noise(x,y,m,n,w):
    y1 = np.abs(Ex_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y3 = np.abs(Ey_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y5 = np.abs(Ez_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y7 = np.abs(Hx_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y9 = np.abs(Hy_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y11 = np.abs(Hz_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y13 = np.abs(Ex_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y15 = np.abs(Ey_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y17 = np.abs(Ez_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y19 = np.abs(Hx_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y21 = np.abs(Hy_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y23 = np.abs(Hz_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    return y1,y3,y5,y7,y9,y11,y13,y15,y17,y19,y21,y23
def generate_dataset_angle_with_noise(x,y,m,n,w):
    y2 = np.angle(Ex_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y4 = np.angle(Ey_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y6 = np.angle(Ez_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y8 = np.angle(Hx_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y10 = np.angle(Hy_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y12 = np.angle(Hz_TE(x,y,m,n,w)) + np.random.exponential(1,9000)
    y14 = np.angle(Ex_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y16 = np.angle(Ey_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y18 = np.angle(Ez_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y20 = np.angle(Hx_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y22 = np.angle(Hy_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    y24 = np.angle(Hz_TM(x,y,m,n,w)) + np.random.exponential(1,9000)
    return y2,y4,y6,y8,y10,y12,y14,y16,y18,y20,y22,y24
...
them so that they can be written to a .csv file. The program was ran 6 times, 
with each input parameter array copied and pasted into a .csv file in this manner:"""
